{
  inputs.nixpkgs.url = "github:nixos/nixpkgs/nixos-25.05?dir=lib";
    ...
    in
    {
      lib.packagesFromVersionsFile =
        ...
        let
          ...
          toolVersions =
            if versionsFile == null then
              { }
            else
              builtins.listToAttrs (parseVersions (removeComments (fileLines versionsFile)));
          legacyVersions = builtins.mapAttrs (_: file: lib.fileContents file) legacyVersionFiles;
          versions =
